            ...
            >
                {slides.map((slide) => (
                    <SwiperSlide key={slide.id}>
                        <motion.div
                            className="relative w-full h-[200px] md:h-[420px] flex items-center justify-center"
                    ...
                    {slides.map((slide, idx) => (
                        <SwiperSlide key={slide.id} className="cursor-pointer">
                            <motion.img
                                src={slide.image}
                                alt={slide.title}
                                className="w-full h-14 md:h-18 object-cover rounded-lg border border-gray-200"
