...
const ItemsCard = ({ item }) => {
    ...
    return (
        <div className="rounded-lg cardAnim shadow-md overflow-hidden bg-gradient-to-br from-teal-400 via-cyan-500 to-emerald-600 text-white transform transition-transform duration-300 hover:scale-105 flex flex-col xl:flex-row items-center xl:items-start justify-center md:justify-start py-4 dark:bg-gray-800">
            <img
                src={item.thumbnail}
